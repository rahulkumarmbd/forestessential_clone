...
document.getElementById("aaa").addEventListener("click", function (e) {
  ...
  if (mobile.length == 0) {
    ...
    valid = false;
    alert("Mobile Number input field is Empty!");
  } else {
  ...
  if (emailAddress.length == 0) {
    ...
    valid = false;
    alert("Email Address input field is empty!");
    ...
    document.getElementById("passwordconfirmation").style.border =
      "1px solid red";
    valid = false;
    alert("Your conformation Password is wrong!");
    ...
    valid = false;
    alert("Both Password field have different Values!");
  } else {
    document.getElementById("alert-cpass").textContent = "";
    document.getElementById("email_address").style.border = "";
