...
<<<<<<< Updated upstream
    ...
    if (emailAddress.length == 0) {
        ...
        document.getElementById("passwordconfirmation").style.border = "1px solid red"
        valid = false;
    } else if (pass != passwordConfirmation) {
        document.getElementById("passwordconfirmation").style.border = ""
        document.getElementById("alert-cpass").textContent = "Confirm Password doesn't matched!";
        ...
        for (var i = 0; i < userArr.length; i++) {
            if (userArr[i].emailAddress == emailAddress) {
                document.getElementById("alert-email").textContent = "Email Already Exist!!";
